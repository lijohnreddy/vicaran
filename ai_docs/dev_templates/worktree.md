...
```bash
PROJECT_ROOT=$(pwd)                    # e.g., /Users/dev/projects/adk-agent-simple
PROJECT_NAME=$(basename "$PROJECT_ROOT") # e.g., adk-agent-simple
PARENT_DIR=$(dirname "$PROJECT_ROOT")    # e.g., /Users/dev/projects
WORKTREE_DIR="${PARENT_DIR}/${PROJECT_NAME}-{name}"  # e.g., /Users/dev/projects/adk-agent-simple-auth
```

**Examples:**
- `/worktree auth` → Folder: `../adk-agent-simple-auth/`, Branch: `feat/auth`
- `/worktree fix-agent` → Folder: `../adk-agent-simple-fix-agent/`, Branch: `fix/fix-agent`
- `/worktree list` → Shows all worktrees
- `/worktree remove auth` → Removes `../adk-agent-simple-auth/` worktree
...
|-----------|--------|--------|
| /path/to/adk-agent-simple | main | (main worktree) |
| /path/to/adk-agent-simple-auth | feat/auth | active |
| /path/to/adk-agent-simple-bugfix | fix/bugfix | active |
```
...
|---|-----------|--------|---------|
| 1 | .../adk-agent-simple | main | Main development |
| 2 | .../adk-agent-simple-auth | feat/auth | Feature: Authentication |
| 3 | .../adk-agent-simple-bugfix | fix/bugfix | Bugfix |

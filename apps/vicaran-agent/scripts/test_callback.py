...
def test_callback():
    ...
    api_secret = os.getenv("AGENT_SECRET", "scryb_agent_2026_a7f3e9c1b5d8k2m4n6p8q0r3s5t7u9w1x3y5z7")
    ...
    try:
        ...
        if e.code == 404:
            ...
            if "Investigation not found" in body:
                print("👉 CAUSE CONFIRMED: The logic rejected the ID because it doesn't exist in the DB.")
            else:
                print("👉 CAUSE: The endpoint itself was not found (Router/Network issue).")
